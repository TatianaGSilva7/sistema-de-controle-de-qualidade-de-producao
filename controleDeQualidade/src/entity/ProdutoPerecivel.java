...
public class ProdutoPerecivel extends ProdutoAlimenticio {
    ...
    public ProdutoPerecivel(String codigo, String nome, String lote, String dataValidade, Boolean embalagemIntegra, String temperaturaArmazenamento, String temperaturaMax, String temperaturaMin) {
    ...
    public void inspecionarQualidade() {
        setEstaAprovado(testarTemperatura() && super.testarEmbalagem());
    }
}
